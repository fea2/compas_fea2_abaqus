...
from compas_fea2_abaqus.model.materials import AbaqusElasticOrthotropic
...
class AbaqusTimber(Timber):
    ...
    def __init__(self, fmk, ft0k, fc0k, ft90k, fc90k, fvk, vLT, vTT, E0mean, E90mean, Gmean, densityk, density, **kwargs):
        super().__init__(fmk, ft0k, fc0k, ft90k, fc90k, fvk, vLT, vTT, E0mean, E90mean, Gmean, densityk, density, **kwargs)
