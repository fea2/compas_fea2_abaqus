...
class AbaqusHardContactFrictionPenalty(HardContactFrictionPenalty):
    ...
    def __init__(self, *, mu, tolerance=0.005, **kwargs) -> None:
        super(AbaqusHardContactFrictionPenalty, self).__init__(mu=mu, tolerance=tolerance, **kwargs)
...
class AbaqusLinearContactFrictionPenalty(LinearContactFrictionPenalty):
    ...
    def __init__(self, *, mu, tolerance=0.005, **kwargs) -> None:
        super(AbaqusLinearContactFrictionPenalty, self).__init__(mu=mu, tolerance=tolerance, **kwargs)
