...
class AbaqusDisplacementFieldResults(DisplacementFieldResults):
    ...
    compas_to_abaqus_component_names = {'x': 'U1', 'y': 'U2', 'z':'U3', 'xx':'UR1', 'yy':'UR2', 'zz':'UR3'}
...
class AbaqusReactionFieldResults(ReactionFieldResults):
    ...
    compas_to_abaqus_component_names = {'x': 'RF1', 'y': 'RF2', 'z':'RF3', 'xx':'RM1', 'yy':'RM2', 'zz':'RM3'}
...
class AbaqusSectionForcesFieldResults(SectionForcesFieldResults):
    ...
    compas_to_abaqus_component_names = {"Fx_1": "SF1", "Fz_1": "SF2", "Fy_1":"SF3",
                                        "Mx_1": "SM3", "My_1": "SM1", "Mz_1": "SM2",
                                        "Fx_2": "S", "Fz_2": "R", "Fy_2":"T",
                                        "Mx_2": "U", "My_2": "V", "Mz_2": "W"}
...
class AbaqusStressFieldResults(StressFieldResults):
    ...
    compas_to_abaqus_component_names = {"s11": "S11", "s22": "S22", "s33": "S33", "s12": "S12", "s13":"S13", "s23": "S23"}
...
class AbaqusContactFieldResults(ContactForcesFieldResults):
    ...
    compas_to_abaqus_component_names = {'Nx': 'CNORMF1', 'Ny': 'CNORMF2', 'Nz':'CNORMF3', 'Tx':'CSHEARF1', 'Ty':'CSHEARF2', 'Tz':'CSHEARF3'}
